...
//navbar
 ...
 let all_products = document.querySelectorAll(
   ".products__contain__circle__part"
 );
 let product_contain_a = document.querySelectorAll(
   ".products__contain__circle__part__link"
 );
 let text = document.querySelector(
   ".products__contain__circle__p-box__content-of-product"
 );
 all_products.forEach((part, index, array) => {
   part.addEventListener("mouseenter", (e) => {
     text.innerText = content_for_path[index];
     all_products.forEach((part, otherIndex, array) => {
       if (otherIndex != index) {
         product_contain_a[index].classList.add("color-hover");
         part.classList.add("for-hover");
       }
     });
   });
   part.addEventListener("mouseleave", (e) => {
     ...
     all_products.forEach((part, otherIndex, array) => {
       if (otherIndex != index) {
         product_contain_a[index].classList.remove("color-hover");
         part.classList.remove("for-hover");
       }
     });
   });
 });
